<?php
	...
	$pages = array(
		array(
			'id' => 'a188dd9cfa60000804666376dffe914b',
			'alias' => '',
			'file' => 'a188dd9cfa60000804666376dffe914b.php',
			'controllers' => array(),
			'type' => 0
		)
	);
	$forms = array(
		'a188dd9cfa60000804666376dffe914b' => array(
			'91967b35' => array(
				'email' => 'penpal@dreemcorp.com',
				'emailFrom' => 'no-reply@cryptopandemic.com',
				'subject' => 'CryptoPandemic Message',
				'sentMessage' => 'Thank you for contacting us! We will get back to you promptly.',
				'object' => '',
				'objectRenderer' => '',
				'loggingHandler' => '',
				'smtpEnable' => false,
	...
	${'redirectItems'} = array();
	$websiteUID = '188309dffaa24250da8f00fd8dc2e7bacc3c1b3eb298455b72b4f5402525b3eb24db9c4e03cd090f';
	$base_dir = dirname(__FILE__);
	$base_url = '/';
	$user_domain = 'cryptopandemic.com';
	$pretty_domain = 'cryptopandemic.com';
	$home_page = 'a188dd9cfa60000804666376dffe914b';
	$mod_rewrite = true;
	$show_comments = false;
